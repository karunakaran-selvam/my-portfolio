  ...
  return (
    <div className="bg-[#FFFFFF]">
      <div className="max-w-[90%] mx-auto py-3 flex items-center justify-between font-inter">
        {/* Logo */}
        <div>
          <h1 className="text-[2.5rem] font-bold text-[#000] hover:text-[#0a66c2] ">
            {/* Karunakaran */}
          </h1>
        </div>
        ...
        <div className="lg:hidden">
          <button
            ...
            className=" transition-all duration-500 ease-in text-[#0a66c2] "
          >
        ...
        >
          <ul className="flex flex-col gap-3 lg:flex-row lg:items-center lg:gap-5 text-[14px] font-semibold">
            <Link to="home" smooth={true} duration={500}>
              <li className="hover:text-[#0a66c2] cursor-pointer transition-transform duration-300 ease-in transform hover:translate-y-[-7px] ">
                Home
              </li></Link>
          ...
          <div
            className={`${isMenuOpen ? "block" : "hidden"} lg:hidden mt-3 flex justify-center gap-5`}
          >
            <a
              target="_blank"
        ...
        <div className="hidden lg:flex w-[100px] items-center justify-between">
          ...
          <a
            ...
            href="https://www.linkedin.com/in/karunakaran-selvam/"
          >
            <FaLinkedin size={29} className="text-[#0a66c2]" />
          </a>
        </div>
      </div>
    </div>
